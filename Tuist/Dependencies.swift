...
let dependencies = Dependencies(
    ...
    swiftPackageManager: SwiftPackageManagerDependencies(
        [
            ...
            .remote(url: "https://github.com/RxSwiftCommunity/RxFlow", requirement: .exact("2.13.0")),
            .remote(url: "https://github.com/ReactorKit/ReactorKit.git", requirement: .exact("3.2.0")),
            .remote(url: "https://github.com/RxSwiftCommunity/RxDataSources", requirement: .exact("5.0.2")),
            .remote(url: "https://github.com/Swinject/Swinject", requirement: .exact("2.8.3"))
        ],
        productTypes: [
